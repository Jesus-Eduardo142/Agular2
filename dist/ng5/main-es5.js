...
var AboutComponent = /** @class */ (function () {
    ...
    AboutComponent.prototype.get = function () {
        var _this = this;
        return this.service.getGames().subscribe(function (gameSystemList) {
            _this.games = gameSystemList;
            _this.count = _this.games.length;
        });
    };
    AboutComponent.prototype.post = function () {
        var _this = this;
        var game = new _game__WEBPACK_IMPORTED_MODULE_4__["Game"]();
        game.name = this.name;
        game.developer = this.developer;
        game.gamesystem = this.gameSystem;
        game.genre = this.genre;
        game.year = parseInt(this.year, 10);
        return this.service.postGame(game).subscribe(function (response) {
    ...
    AboutComponent.prototype.delete = function (id) {
        var _this = this;
        return this.service.deleteGame(id).subscribe(function (response) {
            console.log(response);
            _this.get();
        });
    };
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getGameSystems = function () {
    ...
    DataService.prototype.postGameSystem = function (body) {
    ...
    DataService.prototype.deleteGameSystem = function (id) {
    ...
    DataService.prototype.postGame = function (body) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.get = function () {
        var _this = this;
        return this.service.getGameSystems().subscribe(function (gameSystemList) {
            _this.gameSystems = gameSystemList;
            _this.count = _this.gameSystems.length;
        });
    };
    HomeComponent.prototype.post = function () {
        var _this = this;
        var gameSystem = new _gameSystem__WEBPACK_IMPORTED_MODULE_4__["GameSystem"]();
        gameSystem.name = this.name;
        gameSystem.description = this.description;
        return this.service.postGameSystem(gameSystem).subscribe(function (response) {
            console.log(response);
            _this.name = '';
            _this.description = '';
            _this.get();
    ...
    HomeComponent.prototype.delete = function (id) {
        var _this = this;
        return this.service.deleteGameSystem(id).subscribe(function (response) {
            console.log(response);
            _this.get();
        });
    };
